...
We appreciate your interest in contributing to Awaaz!  
Awaaz aims to foster civic engagement and community collaboration, and we welcome contributors from all backgrounds.
...
2. **Clone the repository:**
  ...
  ```bash
git clone https://github.com/HarshS16/Awaaz.git
cd Awaaz
```
git clone https://github.com/Harshs16/awaaz.git
...
2. **Install dependencies:**
   ...
   ```
3. **Database Setup:** 
Create a new database for Awaaz:

```bash
```

Edit your configuration (typically a .env) to connect to your MongoDB database:
```bash
DB_NAME=awaaz
