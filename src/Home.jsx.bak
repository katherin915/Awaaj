...
const questions = [
  {
    id: 1,
    question: "What is Awaaz?",
    answer: "Awaaz is an AI-powered civic engagement platform that allows citizens to report and track local issues in their communities, such as potholes, broken streetlights, and garbage collection problems. AI automatically classifies and prioritizes issues for faster resolution.",
    popular: true,
    icon: (
  ...
  {
    id: 3,
    question: "Is Awaaz free to use?",
    answer: "Yes, Awaaz is completely free for citizens to use. There are no hidden fees or charges.",
    popular: true,
    icon: (
      <svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    answer: "You can track the status of your report through the Awaaz app or website. You will receive notifications when your issue is reviewed and resolved.",
    icon: (
      <svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        <path d="M12 8v4l3 3" />
        <circle cx={12} cy={12} r={10} />
 ...
 const testimonials = [
    ...
    { 
      quote: "As a city worker, Awaaz has transformed how we manage local issues. The dashboard makes it easy to prioritize and track our work.", 
      name: "Akshay Prakash", 
    ...
    { 
      quote: "The transparency and speed of resolution through Awaaz has restored my faith in local government. Highly recommend to every citizen.", 
      name: "Meera Sharma", 
    ...
    { 
      quote: "Our community engagement has increased by 300% since implementing Awaaz. Citizens feel heard and empowered to make real change.", 
      name: "Rahul Singh", 
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <Helmet>
        ...
        <meta name="description" content="Awaaz helps citizens report and track local civic issues like potholes, broken lights, and garbage collection problems. Make your city better today!" />
      </Helmet>
      ...
      <div className="relative container mx-auto px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            See what citizens and city workers are saying about Awaaz and how it's transforming communities across the nation.
          </p>
        </div>
    ...
    <motion.div className="flex flex-col items-center space-y-4 text-center w-full" variants={itemVariants}>
      <div className="space-y-2">
        ...
        <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
          Find answers to commonly asked questions about Awaaz platform features and services.
        </p>
      </div>
      {/* FAQ Filter */}
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="flex flex-col justify-center space-y-4 animate-on-scroll">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed">Download the Awaaz app today and start making a difference in your neighborhood.</p>
                </div>
