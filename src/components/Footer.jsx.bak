...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/company/awaaz",
      icon: Linkedin,
    ...
    {
      name: "YouTube",
      href: "https://youtube.com/c/awaaz",
      icon: Youtube,
    ...
    },
    {
      ...
      links: [
        ...
        },
        {
          ...
          href: "/tutorials",
          icon: UsersIcon,
          description: "Learn how to use Awaaz",
        },
      ],
    },
    {
        ...
        <div className="text-center py-8 border-t border-slate-200/50 dark:border-slate-700/50">
          <div className="max-w-xl mx-auto space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-slate-600 dark:text-slate-300 text-sm">
                Your feedback helps us improve Awaaz for everyone
              </p>
            </div>
        ...
        <div className="border-t border-slate-200/50 dark:border-slate-700/50 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-slate-500 dark:text-slate-400 text-xs flex items-center">
              © {currentYear} Awaaz. All rights reserved.
