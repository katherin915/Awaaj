...
const DownloadIOS = () => {
  ...
  const faqs = [
    {
      question: "Is the Awaaz app free to use on iOS?",
      answer: "Yes, Awaaz is completely free for all iPhone users as well."
    },
    {
    ...
    },
    {
      ...
      answer: "Awaaz supports iOS 13 and above, covering all modern iPhones."
    },
    {
      question: "Does it support iPads?",
      answer: "Yes, Awaaz will run on both iPhones and iPads for your convenience."
    },
    {
      question: "Is my data secure?",
      answer: "Absolutely. Awaaz for iOS follows strict Apple security and privacy standards."
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Empower your civic voice with Awaaz on iPhone and iPad. Stay connected to your community like never before.
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Everything you need to know about Awaaz for iOS.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-white via-green-50 to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Get Awaaz on Your iPhone
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Scan the QR code below with your iPhone camera to be redirected to the App Store when Awaaz launches.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-r from-green-600 to-emerald-600 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            Be First to Download Awaaz on iOS
          </h2>
          
          <p className="text-xl text-green-100 mb-12 max-w-2xl mx-auto leading-relaxed">
            Sign up and get notified the moment Awaaz is available on the App Store. Join thousands already waiting.
          </p>
