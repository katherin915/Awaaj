...
const SettingsPage = () => {
  ...
  const [settings, setSettings] = useState({
    systemName: 'Awaaz Municipal Platform',
    ...
    smtpServer: 'smtp.awaaz.gov',
    smtpPort: '587',
    smtpUsername: 'admin@awaaz.gov',
    smtpPassword: '',
    emailFromName: 'Awaaz Administration',
    autoBackup: true,
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-green-600">Configure and manage your Awaaz platform</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              {saveStatus === 'saving' && (
