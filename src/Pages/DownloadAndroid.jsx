...
const DownloadAndroid = () => {
  ...
  const faqs = [
    {
      question: "Is the Awaaz app free to use?",
      answer: "Yes, Awaaz is completely free for all users. We believe civic engagement should be accessible to everyone."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, Awaaz is compatible with most Android devices running version 8.0 and above, covering 95% of active Android devices."
    },
    {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Everything you need to know about Awaaz for Android.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-white via-green-50 to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Get Awaaz on Your Android Device
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Scan the QR code below with your Android camera to be redirected to Google Play when Awaaz launches.
            </p>
          </div>
          
          <DownloadPageQRCode 
            title="Awaaz for Android"
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-r from-green-600 to-emerald-600 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-12 max-w-2xl mx-auto leading-relaxed">
            Join thousands already making their voices heard. Be the first to know when Awaaz launches on Android.
          </p>
